 ...
 * Fragmento que representa el apartado del foro "Artista"
 */
public class FragmentoForoArtistas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Creamos e instanciamos el objeto de la clase Query donde buscamos los "posts" donde la categoria de estos sean "Artistas"
        Query query_post = collectionReference_foro.whereEqualTo("categoria", "Artistas");
        ...
        query_post.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                //Recorremos los datos obtenidos y por cada datro, obtenemos el nombre de usuario
                for (QueryDocumentSnapshot documentSnapshot_foro : task.getResult()) {
                    ...
                    query_perfil.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            //Recorremos los datos obtenidos, creamos un nuevo objeo de la clase "Foro" y los añadimos al ArrayList de foros
                            ...
                            recyclerView = view.findViewById(R.id.listadoForoArtista);
